...
interface TceColumnsModalProps {
  columns: TceColumnDefinition[];
  onClose: () => void;
  onColumnVisibilityChange: (columnId: string, checked: boolean) => void;
}

// Modal de configuracao das colunas visiveis da grade dinamica do TCE.
export const TceColumnsModal: FunctionalComponent<TceColumnsModalProps> = ({
  columns,
  onClose,
